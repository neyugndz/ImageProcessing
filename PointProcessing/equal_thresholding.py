...
#Enhance image using Point Processing (Thresholding)
def thresholding(img):
    width, height = img.size
    img_th = Image.new('L', (width, height))
...
plt.subplot(2, 3, 3)
plt.imshow(img_th, cmap='gray', interpolation='nearest')
...
hist3 = calHist(img_th)
plt.subplot(2, 3, 6)
plt.bar(range(256), hist3, color = 'gray')
plt.title('Grayscale Histogram of Thresholding Image')
plt.xlabel('Pixel value')
plt.ylabel('Frequency')
